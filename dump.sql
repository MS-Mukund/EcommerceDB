...
CREATE TABLE `Category1` (
  `Category1_ProductID` int DEFAULT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `Category2` (
  `Category2_ProductID` int DEFAULT NOT NULL AUTO_INCREMENT,
  `Attrib_1` varchar(128) DEFAULT NULL,
  `Attrib_2` varchar(128) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Category3` (
  `Category3_ProductID` int DEFAULT NOT NULL AUTO_INCREMENT,
  `Attrib_1` varchar(128) DEFAULT NULL,
  `Attrib_2` varchar(128) DEFAULT NULL,
...
CREATE TABLE `Item` (
  ...
  `I_Product_ID` int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `Products` (
  `Product_ID` int NOT  AUTO_INCREMENT,
